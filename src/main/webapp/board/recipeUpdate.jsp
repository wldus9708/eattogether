...
<body>
	<section action="<%=withFormTag%>">
		...
		<div class="button">
				<a type="button" href="<%=notWithFormTag%>reUpdate&rec_no=${bean.rec_no}${requestScope.paging.flowParameter}"
